...
export async function POST(request: Request, context: RouteContext): Promise<NextResponse> {
  ...
  // per-destination: a double-click must not record a second publish audit row or post a second
  // Slack message. `null` means this artifact was already announced to Slack.
